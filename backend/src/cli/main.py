...
from core import GraphDB, route, answer_from_activation, answer_as_dict, verify, apply_karma
from core.config import DEFAULT_DB_PATH, API_HOST, API_PORT
...
def cmd_server(args):
    ...
    uvicorn.run("api.app:app", host=host, port=port, workers=1)
